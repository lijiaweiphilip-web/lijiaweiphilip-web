...
- **[l40s-llm-bench](https://github.com/lijiaweiphilip-web/l40s-llm-bench)** - reproducible LLM-serving benchmark scaffold with dry runs, sanity checks, workload profiles, regression comparison, and run manifests.
...
|---|---|---|
| l40s-llm-bench | Public flagship | Add first real vLLM smoke run when GPU/server access is ready |
